...
<section class="relative z-10 overflow-hidden bg-white py-20 lg:py-[50px] dark:bg-slate-900" id="contact">
    <div class="container">
            ...
            <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
                <div class="mb-12 max-w-[570px] lg:mb-0">
                    ...
                    <div class="mb-8 flex w-full max-w-[370px]">
                        <div
                            class="mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-primary bg-opacity-5 dark:text-white text-primary sm:h-[70px] sm:max-w-[70px]">
                    ...
                    <div class=" mb-8 flex w-full max-w-[370px]">
                            <div
                                class="mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-primary dark:text-white bg-opacity-5 text-primary sm:h-[70px] sm:max-w-[70px]">
                            ...
                            <div class="w-full">
                                ...
                                <p class="text-base text-body-color dark:text-gray-400">(+93)706 760 322</p>
                            </div>
                        </div>
                        ...
                        <div class="mb-8 flex w-full max-w-[370px]">
                            ...
                            <div class="w-full">
                                ...
                                <p class="text-base text-body-color dark:text-gray-400">abbasroholamin@gmail.com</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="w-full px-4 lg:w-1/2 xl:w-5/12">
                    <div
                        class="relative rounded-lg bg-white dark:bg-slate-900 dark:bg-opacity-1 dark:text-white p-8 dark:shadow-2xl shadow-xl sm:p-12">
                        <form action="/contact/submit" method="POST" x-data="
                    {
                        ...
                        submitForm(event){
                            ...
                            fetch('/contact/submit',{
                                ...
                                this.successMessage = 'Thanks for your contact request. I well get back to you shortly.';
                        ...
                        <div>
                            <x-common.circle-svg class="absolute -top-10 -right-9 z-[-1]"></x-common.circle-svg>
                            <x-common.dot-svg class="absolute -right-10 top-[90px] z-[-1]"></x-common.dot-svg>
                            <x-common.dot-svg class="absolute -left-7 -bottom-7 z-[-1]"></x-common.dot-svg>
                        </div>
                    </div>
                </div>
            </div>
