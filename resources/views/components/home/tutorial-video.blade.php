<!-- ====== Video Section Start -->
<section x-data="{ videoOpen: false}" class="bg-white py-20 lg:py-[120px] dark:bg-slate-900">
    <div class="container">
        <div class="-mx-4 flex flex-wrap justify-center">
            <div class="w-full px-4 lg:w-10/12">
                <div class="relative z-20 h-[300px] overflow-hidden rounded-lg md:h-[450px]">
                    <div class="absolute top-0 left-0 h-full w-full">
                        <img src="{{ url('images/videos/image-01.jpg') }}" alt="image"
                            class="h-full w-full object-cover object-center" />
                    </div>
                    <div
                        class="absolute top-0 left-0 z-10 flex h-full w-full items-center justify-center bg-primary bg-opacity-90">
                    ...
                    <div>
                        <x-common.dot-svg class="absolute top-4 left-4 z-40"></x-common.dot-svg>
                        <x-common.dot-svg class="absolute bottom-4 right-4 z-40"></x-common.dot-svg>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div x-show="videoOpen" x-transition
        ...
        <div @click.outside="videoOpen = false" class="mx-auto w-full max-w-[550px] bg-white">
            <iframe class="h-[320px] w-full" src="https://www.youtube.com/embed/LXb3EKWsInQ?autoplay=1&mute=1">
            </iframe>
        </div>
